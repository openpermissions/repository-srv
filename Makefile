...
dev_register:
	python repository register_service developer.hub@example.com password developerco

dev_setup: dev_install dev_register

test_register:
	python repository register_service copyright.hub@example.com password hogwarts
